...
export default function AdminBookings() {
  ...
  const handleSubmit = async () => {
    if (!selectedStudent || !selectedTrip || !selectedSeat) return;
  ...
  return (
    <div className="page-container max-w-3xl mx-auto animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <button onClick={() => { setShowForm(true); setSelectedStudent(''); setSelectedTrip(''); setSelectedSeat(null); }} className="btn-primary flex items-center gap-1.5">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  disabled={loading || !selectedStudent || !selectedTrip || !selectedSeat}
                  className={`flex-1 py-2.5 rounded-xl text-sm font-bold transition-all flex items-center justify-center gap-2 ${
                    !selectedStudent || !selectedTrip || !selectedSeat
